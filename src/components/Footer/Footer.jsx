  ...
  return (
    <footer className="bg-[#12141e] pt-12">
      ...
      <div className="container">
        <div className="sm:flex items-center jsutify-between md:gap-8">
          ...
          <div className="w-full sm:w-1/2">
            <p className="text-gray-300 leading-7 mt-4 sm:mt-0">
              ...
              saepe ducimus eum distinctio quisquam et doloribus. Quisquam,
              corrupti porro.
            </p>
      ...
      <div className="bg-[#1b1e29] py-1 mt-14">
        <div className="container">
          <div className="flex items-center justify-center sm:justify-between ">
            ...
            <div>
              <p className="text-gray-400 text-[14px]">
                Copyright {year} developed by Shaon - All right reserved.
              </p>
            </div>
          </div>
        </div>
