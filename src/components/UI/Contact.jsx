    ...
    return (
        <section id="contact" className="pb-16">
            <div className="container">
                <h2 className="text-headingColor font-[700] text-[2rem] mb-8">Get in Touch</h2>
                <div className="md:flex justify-between items-center">
                    <div className="w-full md:w-1/2 h-[300px] sm:h-[450px]">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3687.173815903756!2d91.96846477372404!3d22.460101637087092!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ad2fc05a3f700d%3A0x4d4660844f08fe2a!2sCUET%20main%20gate!5e0!3m2!1sen!2sbd!4v1694011273558!5m2!1sen!2sbd" className="border-0 w-full h-full"  allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    ...
                    <div className="w-full mt-8 md:mt-0 md:w-1/2 sm:h-[450px] lg:flex items-center bg-indigo-100 px-4 lg:px-8 py-8">
                        <form className="w-full">
                            ...
                            <div className="mb-5">
                                <textarea type="text" placeholder="Write your message" rows={3} className="w-full p-3 focus:outline-none rounded-[5px]" />
                            </div>
