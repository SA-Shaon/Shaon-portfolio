...
const Modal = ({ activeID, setShowModal }) => {
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      <div className="w-11/12 md:w-full md:max-w-[600px] max-h-[600px] overflow-scroll absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5">
        <div>
          <figure>
        ...
        <button
          ...
          className="w-[1.5rem] h-[1.5rem] bg-white absolute top-[1.7rem] right-[1.7rem] text-[20px] flex items-center justify-center rounded-[3px] leading-0 cursor-pointer"
        >
          {" "}
          x{" "}
        </button>
