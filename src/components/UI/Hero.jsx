            ...
            <div className="container pt-14">
                <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
                    ...
                    <div className="w-full md:basis-1/2">
                        ...
                        <h1 data-aos="fade-up" data-aos-duration="1500" className="text-headingColor font-[800] text-[1.8rem] sm:text-[40px] leading-[35px] sm:leading-[46px] mt-4">I'm SA Shaon <br /> Software Developer</h1>
                        ...
                        <p data-aos="fade-left" data-aos-duration="1500" className="flex gap-2 mt-12 text-headingColor font-[500] text-[15px] leading-7 sm:pl-14 sm:pr-10"><i className="ri-apps-2-line"></i>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore rem exercitationem excepturi corrupti sequi non in asperiores cum, atque modi!</p>
                        <div className="flex items-center gap-7 mt-14">
                            <span className="text-smallTextColor text-[15px] font-[600]">Follow me:</span>
                            <span>
                                <a href="#youtube" className="text-smallTextColor text-[18px] font-[600] mr-5"><i className="ri-youtube-line"></i></a>
                                <a href="#github" className="text-smallTextColor text-[18px] font-[600] mr-5"><i className="ri-github-fill"></i></a>
                                <a href="#linkedin" className="text-smallTextColor text-[18px] font-[600] mr-5"><i className="ri-linkedin-fill"></i></a>
                                <a href="#facebook" className="text-smallTextColor text-[18px] font-[600] mr-5"><i className="ri-facebook-circle-line"></i></a>
                            </span>
                        </div>
                    </div>
                    {/* Hero image  */}
                    ...
                    <div className="md:basis-1/5 flex justify-between text-center mt-10 flex-wrap gap-3 md:mt-0 md:flex-col md:justify-end md:text-end">
                        ...
                        <div className="mb-10">
                            <h2 className="text-headingColor font-[700] text-[32px]">
                                <CountUp start={0} end={248} duration={2} suffix="+"></CountUp>
                            </h2>
